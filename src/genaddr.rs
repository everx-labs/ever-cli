...
use ton_client::utils::{convert_address, AddressStringFormat, ParamsOfConvertAddress};
...
fn update_contract_state(
    ...
    let pubkey_object =
        PublicKey::from_bytes(pubkey).map_err(|e| format!("unable to load public key: {}", e))?;
